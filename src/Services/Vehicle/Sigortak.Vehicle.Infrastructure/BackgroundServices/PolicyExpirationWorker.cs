...
namespace Sigortak.Vehicle.Infrastructure.BackgroundServices;
...
public class PolicyExpirationWorker : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        // Wait a few seconds initially to let other initializations run
    ...
    public async Task CheckExpiringPoliciesAsync(CancellationToken cancellationToken)
    {
        ...
        foreach (var policy in activePolicies)
        {
            ...
            // Bitiş tarihi 30, 15 veya 7 gün kalanlar
